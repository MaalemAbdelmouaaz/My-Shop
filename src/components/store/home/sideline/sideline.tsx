...
export default function Sideline() {
  return (
    <div>
      <div className="z-30 w-10 h-full absolute top-0 right-0 bg-gradient-to-t from-purple-primary to-purple-secondary text-[13px] duration-100">
        <div className="fixed top-[35%] -translate-y-1/2 text-center">
          ...
          >
            <span
              className="hidden group-hover:block absolute -left-[160px] top-0.5 bg-gray-dark text-white px-4
             py-[0.8rem] rounded-sm transition-all duration-500 ease-linear"
            >
              Check your profile
            </span>
            <div className="hidden group-hover:block w-0 h-0 border-[12px] border-transparent border-l-gray-dark border-r-0 absolute left-[-15px] top-[38%] transition-all duration-500 ease-in-out" />
          </Link>
