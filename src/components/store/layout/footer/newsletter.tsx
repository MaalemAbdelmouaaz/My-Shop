...
export default function Newsletter() {
  return (
    <div className="bg-gradient-to-r from-purple-primary to-purple-secondary p-5">
        ...
        <div className="flex flex-col gap-y-4 xl:flex-row items-center text-white">
          ...
          <div className="flex items-center xl:w-[58%]">
            <h5 className="flex items-center gap-x-2">
              ...
              <span className="ml-10">
                ...and receive &nbsp;
                <b>د.ج350 coupon for first shopping</b>
              </span>
            </h5>
          </div>
          {/* Right */}
          <div className="flex w-full xl:flex-1">
            <input
              ...
              className="w-full h-10 pl-6 bg-card text-foreground rounded-l-full outline-none"
            />
            <span className="h-10 w-24 text-sm grid place-content-center rounded-r-full bg-gray-dark text-white cursor-pointer">
              Sign up
            </span>
          </div>
        </div>
